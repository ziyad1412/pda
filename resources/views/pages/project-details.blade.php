...
@section('content')
    ...
    <main class="main">
        ...
        @include('partials.page-title', ['title' => 'Project Details'])
                ...
                "clickable": true
                    ...
                    <div class="swiper-wrapper align-items-center">
                        ...
                        <div class="swiper-slide">
                            <img src="{{ asset('template/assets/img/projects/remodeling-1.jpg') }}" alt="">
                        </div>

                        <div class="swiper-slide">
                            <img src="{{ asset('template/assets/img/projects/remodeling-2.jpg') }}" alt="">
                        </div>

                        <div class="swiper-slide">
                            <img src="{{ asset('template/assets/img/projects/remodeling-3.jpg') }}" alt="">
                        </div>
